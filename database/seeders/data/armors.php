...
return [
    'skills' => [
        ...
        [
            ...
            'description' => [
                'en' => 'When you draw :damage_attack_icon:, draw +2 :damage_attack_icon:, then choose 2 :damage_attack_icon: to place back on top of your damage deck before inflicting damage to the monster.',
                'es' => 'Cuando robes :damage_attack_icon:, roba +2 :damage_attack_icon: y después elige 2 :damage_attack_icon: para devolverlas a la parte superior de tu mazo de daño antes de infligir daño al monstruo.',
            ],
        ],
        [
            'name' => [
            ...
            'description' => [
                'en' => 'When you select a broken body part to attack, your attack cards which inflict damage gain +1 :damage_attack_icon:.',
                'es' => 'Cuando selecciones una parte del cuerpo rota para atacar, tus cartas de ataque que inflijan daño obtienen +1 :damage_attack_icon:.',
            ],
        ],
        [
        ...
        [
            'bonus-set' => ['Kirin Horn', 'Kirin Jacket', 'Kirin Leg Guards'],
            'name' => [
                'en' => 'Kirin Favour',
                'es' => 'Favor de Kirin',
            ],
            'description' => [
                'en' => 'Once per quest, after the group have rolled on the monster\'s reward table, you may roll for rewards a second time.',
                'es' => 'Una vez por misión, después de que el grupo haya tirado en la tabla de recompensas del monstruo, puedes tirar por recompensas una segunda vez.',
            ],
        ],
    ],
