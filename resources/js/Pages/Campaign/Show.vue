        ...
        <div>
            <div class="max-w-7xl mx-auto py-6 px-4 sm:py-10 sm:px-6 lg:px-8">
                <ActionSection>
                    ...
                    <template #content>
                        ...
                        <div class="col-span-6 relative">
                            ...
                            <div class="mt-2">
                                <div
                                    class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400"
                                    v-html="campaign.description_parsed_html"
                                />
                            </div>
                ...
                <ActionSection v-if="showFullCalendar">
                    ...
                    <template #content>
                        <!-- Campaign Calendar -->
                        <div class="col-span-6 relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <CampaignDay
